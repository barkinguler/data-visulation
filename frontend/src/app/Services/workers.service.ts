...
export class WorkersService {
  ...
  async createWorker(workerInfo) {
    ...
    await this.http
      .post(this.workerApiBaseUrl + 'createWorker', workerInfo, {
        headers: this.header,
      })
      .toPromise()
      .catch((header) => {
  ...
  async getWorkersforFactory(value: number) {
    document.body.style.cursor = 'wait';
    this.workers = await this.http
      .get(this.workerApiBaseUrl + 'getAllUserByWorkplaceId/' + value, {
        headers: this.header,
      })
      .toPromise()
      .catch((header) => {
  ...
  async updateWorkerById(id, workerInfo) {
    ...
    let response = await this.http
      .put(this.workerApiBaseUrl + 'updateWorkerById/' + id, workerInfo, {
        headers: this.header,
      })
      .toPromise()
      .catch((header) => {
  ...
  async deleteWorkerById(id) {
    document.body.style.cursor = 'wait';
    let response = await this.http
      .delete(this.workerApiBaseUrl + 'deleteWorkerById/' + id, {
        headers: this.header,
      })
      .toPromise()
      .catch((header) => {
